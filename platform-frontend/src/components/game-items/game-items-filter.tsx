...
export function NFTItemsFilter({
  ...
  return (
    <div className="mb-6 space-y-3 rounded-2xl border border-white/7 bg-white/2 p-4">
      ...
      {/* Rarity filtering is disabled for now because metadata rarity values are inconsistent. */}
