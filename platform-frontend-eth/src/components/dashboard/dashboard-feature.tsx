...
const FEATURES = [
  {
    ...
    title: 'Game Registry',
    description: 'Register your blockchain game and manage its on-chain identity with Ethereum keypairs.',
  },
  {
    icon: <Shield className="h-5 w-5 text-indigo-400" />,
    title: 'NFT Items',
    description: 'Browse, collect, and trade unique in-game items as verifiable NFTs on Ethereum.',
  },
  {
    icon: <Zap className="h-5 w-5 text-cyan-400" />,
    title: 'Instant Trades',
    description: 'Fast, transparent transactions powered by Ethereum. No middlemen, no delays.',
  },
  {
            ...
            {[
              ...
              >
                ...
                <div className="mt-1 flex items-center justify-between">
                  ...
                  <span className="text-xs font-medium text-emerald-400">{item.price} ETH</span>
                </div>
              </div>
            ))}
          </div>
